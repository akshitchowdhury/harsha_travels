    ...
    <div className="ContactForm flex-1 bg-zinc-950 p-8  shadow-lg">
      ...
      <form className="space-y-6" onSubmit={handleSubmit}>
        ...
        <div>
          <button
            type="submit"
            className="w-[160px] h-[60px] py-3 px-4 bg-white text-white font-medium rounded-md hover:bg-zinc-950 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-300 ease-in-out"
          >
            Contact Us
          </button>
        </div>

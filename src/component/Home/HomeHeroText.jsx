...
const HomeHeroText = () => {
  return (
    <div className="container absolute -my-[50%] lg:-my-[0%] md:-my-[0%] md:labsolute
     md:top-0 lg:absolute lg:right-96 lg:top-[300px]">
      <div className="text-left px-4 md:mx-[45%] w-full">
  ...
  HARSHA <span className="animate-colorChange">TRAVELS</span>
        ...
        Redefining <span className='text-red-500 font-bold'>Corporate TRAVELS </span>
        </p>
        <Link to={"/contact"}>
